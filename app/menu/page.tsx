...
const Menu = () => {
  return (
    <main className="min-w-screen  lg:h-[calc(100vh-8rem)] xl:h-[calc(100vh-9rem)] flex flex-col lg:center bg-gray ">
      <div className="w-full lg:h-3/4  lg:w-[80%]  flex flex-col  lg:flex-row xl:min-w-full">
        {menuData.map((category) => {
          return (
            <Link
              ...
              className={`h-[calc(100vh-5rem)] lg:h-full  lg:w-1/3 center text-third bg-no-repeat  hover:text-white hover:txt-shadow-b txt-shadow-w border-y-4 border-gray  text-center`}
            >
